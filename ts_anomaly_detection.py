...
# x[[0, 12, 17, 25, 30]] = 0
# print(x)
data = pd.read_csv('result.csv',usecols=['time', 'value'],index_col='time')
# print()
x = data['value'].values
# Use the algorithm to find anomalies
anomalies = esd_test(x, 1440, alpha=0.99, ub=0.001, hybrid=True)
...
pyplot.savefig('savefig_example2.png')